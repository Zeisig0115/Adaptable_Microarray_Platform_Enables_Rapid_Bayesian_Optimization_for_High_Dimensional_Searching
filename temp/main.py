...
from fit_model import fit_saasbo, fit_gp, fit_fullyb_gp, fit_saas_gp, fit_prf, fit_mlp_ensemble, fit_ngboost
from metrics import (
    point_metrics,
...
def fold_eval_learn_noise(
    ...
    if model_type == "saasbo":
        ...
        model = fit_ngboost(Xtr, ytr, seed=seed)
    else:
...
def main():
    ...
    parser.add_argument("--model", type=str, choices=["gp", "saasbo", "fullyb_gp", "saas_gp", "prf", "mlp", "ngboost"], default="ngboost")
